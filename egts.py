...
from work_db import Packet_data, create_cursor, connect_main_db


# Процедура получения и отправки пакетов.
def receive_data(connection, data_for_db):
    try:
        while True:
...
def server_work():
    ...
    try:
        while True:
            ...
            t = Thread(target=receive_data, args=(connection, data_for_db))
            t.start()
