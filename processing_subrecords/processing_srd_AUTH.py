...
def pr_EGTS_AUTH_SERVICE(srds, data_for_db):
    ...
    for srd in srds:
        ...
        match hex_to_dec(dict_srd["SRT"]):
            ...
            # это не надо
            case Tsr_EGTS_AUTH_SERVICE.EGTS_SR_MODULE_DATA.value:
                ...
                pass
            # это не надо
            case Tsr_EGTS_AUTH_SERVICE.EGTS_SR_VEHICLE_DATA.value:
                ...
                pass
            # это не надо
            case Tsr_EGTS_AUTH_SERVICE.EGTS_SR_AUTH_PARAMS.value:
                # dict_srd["SRD"], tmp_byte = param_byte(dict_srd["SRD"], 1, False)
                ...
                pass
            # это не надо
            case Tsr_EGTS_AUTH_SERVICE.EGTS_SR_AUTH_INFO.value:
                ...
                pass
            # это не надо
            case Tsr_EGTS_AUTH_SERVICE.EGTS_SR_SERVICE_INFO.value:
                # dict_srd["SRD"], data_srd["ST"] = param_byte(dict_srd["SRD"], 1, False)
                ...
                pass
            # это не надо
            case Tsr_EGTS_AUTH_SERVICE.EGTS_SR_RESULT_CODE.value:
